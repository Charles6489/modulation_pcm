function varargout = pcm_signal(varargin)
% PCM_SIGNAL MATLAB code for pcm_signal.fig
%      PCM_SIGNAL, by itself, creates a new PCM_SIGNAL or raises the existing
%      singleton*.
%
%      H = PCM_SIGNAL returns the handle to a new PCM_SIGNAL or the handle to
%      the existing singleton*.
%
%      PCM_SIGNAL('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PCM_SIGNAL.M with the given input arguments.
%
%      PCM_SIGNAL('Property','Value',...) creates a new PCM_SIGNAL or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before pcm_signal_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to pcm_signal_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help pcm_signal

% Last Modified by GUIDE v2.5 17-Apr-2021 11:11:30

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @pcm_signal_OpeningFcn, ...
                   'gui_OutputFcn',  @pcm_signal_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before pcm_signal is made visible.
function pcm_signal_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to pcm_signal (see VARARGIN)
movegui('center');
set(handles.axes1,'Visible','off');
set(handles.axes2,'Visible','off');
% Choose default command line output for pcm_signal
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes pcm_signal wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = pcm_signal_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global freq amp word_length fs
global t input_sig
global sampled_signal
global h1 quantiz_signal
global dec_val
 global h2 h4 decoded_val 
h1='o';
    h2='o';
    h3='o';
    h4='o';
...
word_length=str2num(get(handles.edit3, 'String'))
