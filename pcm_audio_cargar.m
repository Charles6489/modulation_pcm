function varargout = pcm_audio_cargar(varargin)
% PCM_AUDIO_CARGAR MATLAB code for pcm_audio_cargar.fig
%      PCM_AUDIO_CARGAR, by itself, creates a new PCM_AUDIO_CARGAR or raises the existing
%      singleton*.
%
%      H = PCM_AUDIO_CARGAR returns the handle to a new PCM_AUDIO_CARGAR or the handle to
%      the existing singleton*.
%
%      PCM_AUDIO_CARGAR('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PCM_AUDIO_CARGAR.M with the given input arguments.
%
%      PCM_AUDIO_CARGAR('Property','Value',...) creates a new PCM_AUDIO_CARGAR or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before pcm_audio_cargar_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to pcm_audio_cargar_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help pcm_audio_cargar

% Last Modified by GUIDE v2.5 17-Apr-2021 09:56:19

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @pcm_audio_cargar_OpeningFcn, ...
                   'gui_OutputFcn',  @pcm_audio_cargar_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before pcm_audio_cargar is made visible.
function pcm_audio_cargar_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to pcm_audio_cargar (see VARARGIN)
movegui('center');
set(handles.axes1,'Visible','off');
set(handles.axes2,'Visible','off');
% Choose default command line output for pcm_audio_cargar
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes pcm_audio_cargar wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = pcm_audio_cargar_OutputFcn(hObject, eventdata, handles) 
...
[input_sig orgnal_sampl_freq]=audioread('voz2.wav');
nbits = audioinfo('voz2.wav')
...
audiowrite('voz2.wav',x,Fs);
[x, Fs] = audioread('voz2.wav');
sound(x,Fs);
nbits = audioinfo('voz2.wav');
message=nbits.Filename;
Duration=nbits.Duration;
set(handles.text25,'String',message)
set(handles.text26,'String',num2str(Duration));
set(handles.text27,'String','Duracion :')
set(handles.text28,'String',' Segundos')
msgbox('Correct file');
audioinfo('voz2.wav')   
